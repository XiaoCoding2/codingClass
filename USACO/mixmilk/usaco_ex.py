...
def main():
    with open("mixmilk.in", "r") as numbers2:
        c1, m1 = (int, numbers2.readline()), (int, numbers2.readline())
        c2, m2 = (int, numbers2.readline()), (int, numbers2.readline())
        c3, c3 = (int, numbers2.readline()), (int, numbers2.readline())
